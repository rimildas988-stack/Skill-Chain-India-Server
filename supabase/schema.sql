-- =====================================================================
-- SOVEREIGN TALENT NETWORK (SKILLCHAIN) - SUPABASE DATABASE SCHEMA
-- =====================================================================
-- This SQL script initializes the required tables, security policies,
-- and indexes for custom database synchronization or persistent cloud storage.
-- Run this inside your Supabase dashboard's SQL Editor to set up your tables.

-- 1. State Sync table (Required for the built-in "Sync to Supabase" button)
...
-- Simple permissive policies to allow seamless testing & development syncing
CREATE POLICY "Allow anonymous read/write access" ON skill_chain_sync FOR ALL USING (true) WITH CHECK (true);


-- 2. Full Student Profile Storage
...
-- 3. Opportunities (Projects / Gigs / Escrow Tasks)
...
-- 5. Innovation Ideas (Co-Founder & Sandbox Hub)
